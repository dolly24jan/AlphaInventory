...
class Main(splash,Login,Admin,User):
    ...
    def buildmain(self):
        ...
        self.topframe=LabelFrame(self.mainw,width=1400,height=120,bg="#c7af7d")
        self.topframe.place(x=0,y=0)
        self.store_name = 'The Alpha'
        self.storelable=Label(self.topframe,text=self.store_name + "Inventory System",bg="#c7af7d",anchor="center")
